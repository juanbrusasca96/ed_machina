...
Redis: Sistema de caché en memoria para almacenar resultados de consultas frecuentes.
...
Utils: Funciones utilitarias, como el manejo de caché con Redis.

Manejo de Caché

Para mejorar la eficiencia de la aplicación y reducir la carga sobre la base de datos, 
se ha implementado un sistema de caché utilizando Redis. Los resultados de consultas 
frecuentes, como la obtención de todas las carreras o las materias de una carrera, se 
almacenan temporalmente en Redis para evitar consultas repetidas a la base de datos.
